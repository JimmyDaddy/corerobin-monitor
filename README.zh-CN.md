...
专业模式保留实时指标、五分钟趋势、进程树、网络连接、存储分析和历史记录。网络质量页会自动分层检查本地路由、DNS、IPv4、IPv6、互联网与独立服务，并展示最近 15 分钟的延迟、抖动和连接失败趋势。
...
“关于与支持”可在应用内检查、下载和安装签名稳定版；“存储”页可以安全推出可移除卷；“数据与隐私中心”集中说明资源历史、可选连接历史与本机缓存，并提供一键清除。
